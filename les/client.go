...
import (
	...
	"odinchain/accounts"
	"odinchain/accounts/abi/bind"
	"odinchain/consensus"
	"odinchain/core"
	"odinchain/core/bloombits"
	"odinchain/core/rawdb"
	"odinchain/core/types"
	"odinchain/odin"
	"odinchain/odin/downloader"
	"odinchain/odin/filters"
	"odinchain/odin/gasprice"
	"odinchain/internal/ethapi"
	"odinchain/light"
	"odinchain/node"
	"odinchain/params"
	"odinchain/rpc"
...
func New(ctx *node.ServiceContext, config *odin.Config) (*LightEthereum, error) {
	...
	leth := &LightEthereum{
		...
		engine:         odin.CreateConsensusEngine(ctx, chainConfig, &config.Ethash, nil, false, chainDb),
		bloomRequests:  make(chan chan *bloombits.Retrieval),
		bloomIndexer:   odin.NewBloomIndexer(chainDb, params.BloomBitsBlocksClient, params.HelperTrieConfirmations),
