...
import (
	...
	"odinchain/accounts/external"
	"github.com/ethereum/go-ethereum/cmd/utils"
	"github.com/ethereum/go-ethereum/common"
	"github.com/ethereum/go-ethereum/contracts/checkpointoracle"
	"odinchain/odinclient"
	"odinchain/params"
	"odinchain/rpc"
...
func newClient(ctx *cli.Context) *odinclient.Client {
	client, err := odinclient.Dial(ctx.GlobalString(nodeURLFlag.Name))
	if err != nil {
...
func newContract(client *rpc.Client) (common.Address, *checkpointoracle.CheckpointOracle) {
	...
	contract, err := checkpointoracle.NewCheckpointOracle(addr, odinclient.NewClient(client))
	if err != nil {
