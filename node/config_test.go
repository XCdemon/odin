...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "godin.ipc", false, filepath.Join(os.TempDir(), "godin.ipc")},
		{"data", "godin.ipc", false, "data/godin.ipc"},
		{"data", "./godin.ipc", false, "./godin.ipc"},
		{"data", "/godin.ipc", false, "/godin.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "godin.ipc", true, `\\.\pipe\godin.ipc`},
		{"data", "godin.ipc", true, `\\.\pipe\godin.ipc`},
		{"data", `\\.\pipe\godin.ipc`, true, `\\.\pipe\godin.ipc`},
	}
